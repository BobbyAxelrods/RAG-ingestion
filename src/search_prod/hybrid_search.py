...
class AzureHybridSearch:
    ...
    def __init__(self, search_client, openai_client):
        ...
        self.vector_field = "content_chunk_vector"
        self.search_fields_en = ["content_en", "title_name_en"]
        self.search_fields_tc = ["content_tc", "title_name_tc"]
        ...
        return [
            {
                ...
                "score": result.get("@search.score"),  # RRF combined score
